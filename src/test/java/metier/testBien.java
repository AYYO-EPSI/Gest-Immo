...
//		unBien = Bien.CabaneAuFondDuJardin;
	...
	public void testSurfaceInferieurOuEgale0() {
            try {
                    unBien.setSurface(-1);
                    fail("Impossible d'avoir une surface inferieur ou égale à 0");
	...
	public void testNoteEnergieDoitEtreValide() {
		try {
			unBien.setEnergie('Z');
			fail("Impossible d'avoir une √©nergie not√©e Z.");
		} catch (AppliDataException e) {
		}
	}
	...
	public void testNbPiecesPas0() {
		try {
			...
			fail("Impossible d'obtenir aucune pi√®ces.");
		} catch (AppliDataException e) {
		}
	}
	...
	public void testGarage() {
        ...
        public void testGarageinf0(){
            try{
                unBien.setGarage(-1);
                fail("valeur surface garage non valide car inferieur à 0"); 
            }catch (AppliDataException e){
	...
	public void testVeranda() {
        ...
        public void testTailleVeranda() {
            try{
                unBien.setVeranda(-5);
                fail("valeur surface veranda non valide car inferieur à 0"); 
            }catch (AppliDataException e){
